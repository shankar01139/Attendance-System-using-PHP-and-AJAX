...
<div class="container" style="margin-top:30px">
  <div class="card">
      ...
      <div class="row">
        <div class="col-md-9">Incharge List</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Incharge Name<span class="text-danger">*</span></label>
              <div class="col-md-8">
...
<div class="modal" id="deleteModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <h3 align="center">Are you sure you want to remove this Incharge?</h3>
      </div>
  ...
  $(document).on('click', '.edit_teacher', function(){
  	...
  	$.ajax({
  		...
  		success:function(data)
  		{
  			...
  			$('#modal_title').text('Edit Incharge');
