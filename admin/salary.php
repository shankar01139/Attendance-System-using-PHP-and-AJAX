  ...
  <div class="card">
      ...
      <div class="row">
        ...
        <div class="col-md-3" align="right">
          ...
          <button type="button" id="report_button" class="btn btn-success btn-sm">Salary</button>
        </div>
      </div>
    </div>
  	<div class="card-body">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Make Salary Report</h4>
      ...
      <div class="modal-footer">
        <button type="button" name="create_report" id="create_report" class="btn btn-success btn-sm">Create Salary Report</button>
...
<div class="modal" id="chartModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Create department Attendance Chart</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
